...
bool TriggerConditionChecker::executeCheck(const unordered_map<string, Value>& variables) {
    last_error_.clear();
...
string TriggerConditionChecker::lastError() const {
    return last_error_;
}

vector<TriggerConditionChecker::ConditionElement>
TriggerConditionChecker::getElements() const {
    return elements_;
}

void TriggerConditionChecker::extractElements(const string& condition) {
...
vector<pair<string, string>> TriggerConditionChecker::splitLogicalOps(const string& expr) {
