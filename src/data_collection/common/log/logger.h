 ...
 */
#define AD_INFO(TAG,...)                                                 \
  dcp::common::Logger::instance()->Log(LOG_LEVEL_INFO, #TAG, __FILE__,   \
    __LINE__, __VA_ARGS__)
#define AD_ERROR(TAG, ...)                                               \
  dcp::common::Logger::instance()->Log(LOG_LEVEL_ERROR, #TAG, __FILE__,  \
    __LINE__, __VA_ARGS__)
#define AD_WARN(TAG,...)                                                  \
  dcp::common::Logger::instance()->Log(LOG_LEVEL_WARNING, #TAG, __FILE__, \
    __LINE__, __VA_ARGS__)
