...
#include "trigger/strategy_config.h"
...
class RsclRecorder : public Observer {
  public:
    RsclRecorder(const std::shared_ptr<rscl::Node>& node, const std::shared_ptr<dcp::trigger::Strategy>& s);
  ...
  private: 
    ...
    std::shared_ptr<dcp::trigger::Strategy> strategy_{nullptr};
    dcp::trigger::CacheMode cache_mode_;
